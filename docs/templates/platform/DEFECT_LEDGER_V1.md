...
| --- | --- | --- |
| C0 Shared Runtime | `aa667fcc012a5eed4a6e823741d8867f750417a1` | Exact non-author review running. Earlier staged hashes are superseded. Schema-enabled Python 3.11 has 94/94; Python 3.14 has 93 pass plus the expected unavailable-`jsonschema` skip. |
| C1 Research | `343cae665e2634d5a990920e8cffa9595cbac152` | Exact non-author review running; author gates report Python 3.11/3.14 87/87. |
| C2 Career | `2eb0d6699aedb83ab8fb67658aebdbaf2ed3b422` | Independent exact-commit review running. |
| C3 Quant | `3361ed4063208e0044cdf621db45884a017e9e38` | Independent review FAIL: domain security fixes passed, but the claimed C0 exact mount referenced contract commit `1bce8f9e...`, which did not contain `template_runtime/sdk.py`; handoff metadata was not reproducible. Rebase the mount evidence onto exact C0 commit `aa667fcc...` and submit a new C3 commit. |
