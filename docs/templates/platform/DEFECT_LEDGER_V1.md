...
| C0-004 | P1 | C0 staged candidate before `f822b554a4783817d4fde7eb00c7a194df6bb3cdd7764f8d5cfc7fae223fd0d4` | The openJiuwen lock called annotated tag object `3a322735...` the source commit, while `v0.1.16` peels to commit `1bd42cfe...`; source provenance and SBOM were semantically wrong. | Lock, runtime health, documentation and SBOM distinguish exact tag object from peeled commit; deterministic tests bind both identities. | Fixed in frozen candidate; independent review pending |
...
| --- | --- | --- |
| C0 Shared Runtime | Staged diff `f822b554a4783817d4fde7eb00c7a194df6bb3cdd7764f8d5cfc7fae223fd0d4`; index tree `79cb60f39b0edb6d3a6ab2cffa985640eed4459d` | A non-author must review this exact staged object; the superseded `ad58468...` object must not be reviewed or integrated. Schema-enabled Python 3.11 has 94/94 and Python 3.14 has 93 pass plus the expected unavailable-`jsonschema` skip. |
...
| C3 Quant | `3361ed4063208e0044cdf621db45884a017e9e38` | Exact non-author review running; author gates report Python 3.11/3.14 63/63 and shared schema 26/26 with no skip. |
