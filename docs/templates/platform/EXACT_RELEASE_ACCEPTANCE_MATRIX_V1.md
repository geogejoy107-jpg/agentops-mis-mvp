...
| C1 Research | `a9fa0f02deeab9b3f0f0c90ea4edcd314e644bd0` | Independently confirmed Python 3.11/3.14 90/90, exact C0 production mount, SSH attacks, secret 0 and isolated esbuild bundle | PASS: P0=0, P1=0, P2=0 | ELIGIBLE for candidate integration; combined-head shared wiring/E2E still required |
