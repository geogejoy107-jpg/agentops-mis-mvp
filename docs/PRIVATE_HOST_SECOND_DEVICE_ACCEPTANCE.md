...
`v1.6.0-private-host-preview.21` at exact commit
`c29addf2fb1155e6046432007c7d6282ac6d1754`:
...
- Host health, managed preview.21 production UI and real Hermes/OpenClaw Workers
  are ready;
