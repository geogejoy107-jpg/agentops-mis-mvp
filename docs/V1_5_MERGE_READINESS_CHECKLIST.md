...
- [x] P1-05 has started as a strangler-style split, not a big-bang rewrite.
  ...
  public projection now lives in `agentops_mis_core/workflow_jobs.py`; Commander
  ...
  transitions/stuck-job recovery routing, tool-call row construction/upsert,
