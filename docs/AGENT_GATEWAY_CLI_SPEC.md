...
`agent_work_packet_bundle_v1` for HTTP-only Hermes/OpenClaw agents. That bundle
contains adapter-scoped `agent_work_packet_v1` entries, phase commands, packet
...
work packet before copying a bounded loop-driver command.
