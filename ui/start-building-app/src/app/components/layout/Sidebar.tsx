...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { labelKey: "templates",    path: "/workspace/templates",    icon: <Package size={15} /> },
    ],
  },
  {
    ...
    items: [
      ...
      { labelKey: "evaluationRoom",path: "/workspace/evaluations",     icon: <BarChart2 size={15} /> },
      { labelKey: "toolCalls",     path: "/workspace/tool-calls",      icon: <Wrench size={15} /> },
      { labelKey: "connectors",    path: "/workspace/connectors",      icon: <Plug size={15} /> },
      { labelKey: "externalBases", path: "/workspace/external-bases/notion", icon: <Database size={15} /> },
      { labelKey: "audit",         path: "/workspace/audit",           icon: <ClipboardList size={15} /> },
    ],
  },
];
