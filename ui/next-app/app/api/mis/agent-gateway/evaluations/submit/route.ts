...
import { submitAgentGatewayEvaluation } from "@/server/controlPlane/agentGatewayEvidence";
...
export async function POST(request: NextRequest) {
  try {
    if (controlPlaneMode() === "proxy") return await proxyControlPlaneRequest(request, "/agent-gateway/evaluations/submit");
