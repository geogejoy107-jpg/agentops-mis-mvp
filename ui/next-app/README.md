...
- Deployment contract: local readiness, backup/restore evidence, BYOC recovery drill status, signed audit export readiness, retention/export gates, SSO hooks, and private connector policy load read-only through the MIS API proxy; restore remains CLI-confirmed
