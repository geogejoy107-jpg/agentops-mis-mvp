...
export function parseBoundedJsonObject(rawBody: Buffer, options: BoundedJsonOptions) {
...
export async function boundedJsonObject(request: Request, options: BoundedJsonOptions) {
