...
def main() -> int:
    ...
    require(default_payload.get("commands", {}).get("confirmed_release_grade_receipt_recording") == "python3 scripts/commercial_release_grade_receipt_recording.py --recording-payload-json /tmp/receipt-recording-payload.json --receipts-path docs/COMMERCIAL_EVIDENCE_RECEIPTS.json --confirm-recording", "confirmed receipt recording command missing")
