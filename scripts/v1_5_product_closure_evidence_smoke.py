    ...
    items = [
        ...
        item(
            ...
            source_markers={
                ...
                "ui/start-building-app/src/app/components/pages/WorkerConsole.tsx": ["Worker Control Console", "loadWorkerStatus", "loadWorkerAdapterReadiness", "dispatchLocalWorkerOnce", "startLocalWorkerDaemon", "liveBlocked"],
