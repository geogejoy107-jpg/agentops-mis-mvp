...
def main() -> int:
    ...
    require(checks.get("exact_head_ci_verified") is True, "exact-head CI should now be verified")
    ...
    require("exact_head_ci_not_verified" not in set(payload.get("blockers") or []), "exact-head CI blocker should be cleared")
