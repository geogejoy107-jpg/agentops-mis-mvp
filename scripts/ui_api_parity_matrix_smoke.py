...
def main() -> int:
    ...
    require("python3 scripts/ui_covered_route_retirement_packet_smoke.py" in worker_console_evidence, "worker_console must include covered-route retirement packet evidence")
    ...
    require("ui_covered_route_retirement_packet_v1" in worker_console_gate, "worker_console gate must name the covered-route packet")
    ...
    require("python3 scripts/ui_covered_route_retirement_packet_smoke.py" in control_evidence, "control_tower must include covered-route retirement packet evidence")
