...
def main() -> int:
    ...
    require("python3 scripts/nextjs_local_brief_smoke.py" in pixel_dispatch_evidence, "pixel_office_and_dispatch must include Next local brief dry-run evidence")
    ...
    require("local-brief dry-run controls" in pixel_dispatch_gate, "pixel_office_and_dispatch retirement gate must record Next local brief dry-run evidence")
