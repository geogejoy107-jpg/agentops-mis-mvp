...
def main() -> int:
    ...
    expected_markers = {
        ...
        "ai_execution_mode_selected_status": "const selectedExecutionStatus = selectedAdapterLiveBlocked",
        "ai_execution_mode_selected_label": "const selectedExecutionLabel = selectedAdapterLiveBlocked",
