...
ROUTES = [
    ...
    ("/workspace/commercial", ["Commercial", "Capability matrix", "Fail-closed gates", "Release promotion", "Exact-head CI", "Current evidence", "Check exact-head CI", "commercial_release_status_api_v1"]),
