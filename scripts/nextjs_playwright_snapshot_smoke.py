...
ROUTES = [
    ...
    ("/workspace/workers", ["Worker Console", "Worker fleet lanes", "Fleet hygiene plan", "worker_console_read_model_parity", "session token omitted", "live daemon blocked", "fleet cleanup preview only"]),
