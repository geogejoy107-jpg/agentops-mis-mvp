...
ROUTES = [
    ...
    ("/workspace/commercial", ["Commercial", "Capability matrix", "Fail-closed gates", "Release promotion", "Exact-head CI", "Promotion packet", "Receipt promotion plan", "Receipt rerun bundle", "Gate reruns", "write previews", "Current evidence", "Check exact-head CI", "commercial_release_status_api_v1", "commercial_release_promotion_packet_v1", "commercial_release_grade_receipt_plan_v1", "commercial_release_grade_rerun_bundle_v1"]),
