...
ROUTES = [
    ...
    ("/workspace/commercial", ["Commercial", "Capability matrix", "Fail-closed gates", "Release promotion", "Exact-head CI", "Promotion packet", "Receipt promotion plan", "Receipt rerun bundle", "Gate reruns", "write previews", "Receipt recording preview", "Recording previews", "patch previews", "Transaction preview", "CLI confirm only", "--confirm-recording", "Current evidence", "Check exact-head CI", "commercial_release_status_api_v1", "commercial_release_promotion_packet_v1", "commercial_release_grade_receipt_plan_v1", "commercial_release_grade_rerun_bundle_v1", "commercial_release_grade_receipt_recording_v1"]),
