...
ROUTES = [
    ...
    ("/workspace/commercial", ["Commercial", "Capability matrix", "Fail-closed gates", "Release promotion", "Exact-head CI", "Promotion packet", "Current evidence", "Check exact-head CI", "commercial_release_status_api_v1", "commercial_release_promotion_packet_v1"]),
