...
EXPECTED = {
    ...
    "host_managed_stop_gate": (CONSOLE, "disabled={Boolean(busyAction) || hostManagedRunning}"),
    "host_managed_start_gate": (CONSOLE, "disabled={Boolean(busyAction) || liveBlocked || selectedHostManaged}"),
