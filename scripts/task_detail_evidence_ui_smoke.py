...
def main() -> int:
    ...
    expected_markers = {
        ...
        "task_detail_download_uses_configured_api": "apiResourceUrl(`/artifacts/${encodeURIComponent(artifact.artifact_id)}/download`)",
        "task_detail_download_requires_free_local_approved_ledger_state": "!HUMAN_SESSION_REQUIRED && hasApprovedDelivery",
