...
EXPECTED_MARKERS = {
    ...
    "operator_health_risk_queue_source": "operatorHealth?.risks",
    "operator_health_risk_queue_id": "operator-health:",
    "operator_health_risk_verify": "verifyAction: risk.verify_command",
    "operator_health_risk_receipt": "receiptRecordCommand: risk.receipt_record_command",
    "operator_health_risk_verify_receipt": "receiptVerifyRecordCommand: risk.receipt_verify_record_command",
