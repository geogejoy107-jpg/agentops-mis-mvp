...
EXPECTED_MARKERS = {
    ...
    "close_gap_verify": 'verifyAction: "agentops operator action-plan --limit 20"',
    ...
    "verified_receipt_sort": "!hasVerifiedReceiptForCommands(candidate.action, candidate.verifyAction) ? 80",
