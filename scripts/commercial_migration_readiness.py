...
def main() -> int:
    ...
    checks = [
        ...
        check(
            ...
            and file_contains("docs/AGENT_GATEWAY_CLI_SPEC.md", "Postgres routed task/execution/evidence/plan/memory/audit helper")
            ...
            "experimental Postgres HTTP task, Agent Gateway task, claim, run-start, tool/eval/artifact evidence, Agent Plan, plan-evidence manifest, memory candidate, and run-bound audit write routes are explicitly allowlisted, smoke-tested, and documented",
        ),
        check(
