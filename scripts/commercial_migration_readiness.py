...
def main() -> int:
    ...
    checks = [
        ...
        check(
            ...
            and file_contains("docs/AGENT_GATEWAY_CLI_SPEC.md", "Postgres routed task/execution/evidence helper")
            ...
            "experimental Postgres HTTP task, Agent Gateway task, claim, run-start, and tool/eval/artifact evidence write routes are explicitly allowlisted, smoke-tested, and documented",
        ),
        check(
