...
def main() -> int:
    ...
    checks = [
        ...
        check(
            ...
            "Next commercial page renders read-only release promotion, exact-head CI command, promotion packet, release-grade receipt plan, rerun bundle, and current-evidence blockers from the MIS API without network/live execution",
        ),
        check(
