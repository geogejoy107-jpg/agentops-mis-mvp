...
def main() -> int:
    ...
    checks = [
        ...
        check(
            ...
            "parallel Next.js App Router track has API proxy, workspace/storage/tool-call/evaluation/runtime-connector/Notion external-base data contracts, deployment storage gate, and browser snapshot smoke",
        ),
        check(
