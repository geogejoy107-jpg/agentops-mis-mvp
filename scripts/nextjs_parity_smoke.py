...
def main() -> int:
    ...
    require("Release promotion" in commercial_page_text and "Exact-head CI" in commercial_page_text and "Promotion packet" in commercial_page_text and "Receipt promotion plan" in commercial_page_text and "Current evidence" in commercial_page_text and "Check exact-head CI" in commercial_page_text, "commercial page must expose release promotion packet, receipt plan, and current evidence state")
    require("commercial-release-status" in commercial_page_text and "commercial-release-promotion-preflight" in commercial_page_text and "commercial-promotion-packet" in commercial_page_text and "commercial-release-grade-receipt-plan" in commercial_page_text and "commercial-exact-head-ci-command" in commercial_page_text and "commercial-current-evidence-gates" in commercial_page_text and "commercial-external-ci-readback-form" in commercial_page_text, "commercial page must expose release status smoke markers")
    require("commercial_release_status_api_v1" in commercial_page_text and "commercial_current_evidence_status_v1" in commercial_page_text and "commercial_release_promotion_preflight_v1" in commercial_page_text and "commercial_release_promotion_packet_v1" in commercial_page_text and "commercial_release_grade_receipt_plan_v1" in commercial_page_text, "commercial page must render release status contracts")
