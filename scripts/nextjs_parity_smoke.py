...
def main() -> int:
    ...
    require("Release promotion" in commercial_page_text and "Exact-head CI" in commercial_page_text and "Promotion packet" in commercial_page_text and "Receipt promotion plan" in commercial_page_text and "Receipt rerun bundle" in commercial_page_text and "Current evidence" in commercial_page_text and "Check exact-head CI" in commercial_page_text, "commercial page must expose release promotion packet, receipt plan, rerun bundle, and current evidence state")
    require("commercial-release-status" in commercial_page_text and "commercial-release-promotion-preflight" in commercial_page_text and "commercial-promotion-packet" in commercial_page_text and "commercial-release-grade-receipt-plan" in commercial_page_text and "commercial-release-grade-rerun-bundle" in commercial_page_text and "commercial-exact-head-ci-command" in commercial_page_text and "commercial-current-evidence-gates" in commercial_page_text and "commercial-external-ci-readback-form" in commercial_page_text, "commercial page must expose release status smoke markers")
