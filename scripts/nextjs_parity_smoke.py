...
def main() -> int:
    ...
    require("Release promotion" in commercial_page_text and "Exact-head CI" in commercial_page_text and "Promotion packet" in commercial_page_text and "Receipt promotion plan" in commercial_page_text and "Receipt rerun bundle" in commercial_page_text and "Gate reruns" in commercial_page_text and "write previews" in commercial_page_text and "Receipt recording preview" in commercial_page_text and "Recording previews" in commercial_page_text and "patch previews" in commercial_page_text and "Current evidence" in commercial_page_text and "Check exact-head CI" in commercial_page_text, "commercial page must expose release promotion packet, receipt plan, dynamic rerun bundle, recording preview, and current evidence state")
    require("commercial-release-status" in commercial_page_text and "commercial-release-promotion-preflight" in commercial_page_text and "commercial-promotion-packet" in commercial_page_text and "commercial-release-grade-receipt-plan" in commercial_page_text and "commercial-release-grade-rerun-bundle" in commercial_page_text and "commercial-rerun-bundle-gate-detail" in commercial_page_text and "commercial-release-grade-receipt-recording" in commercial_page_text and "commercial-receipt-recording-gate-detail" in commercial_page_text and "commercial-exact-head-ci-command" in commercial_page_text and "commercial-current-evidence-gates" in commercial_page_text and "commercial-external-ci-readback-form" in commercial_page_text, "commercial page must expose release status smoke markers")
