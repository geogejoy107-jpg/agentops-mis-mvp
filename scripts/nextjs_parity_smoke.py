...
def main() -> int:
    ...
    require('"retirement_action": "executed_workspace_redirect"' in retirement_packet_text, "task/run route retirement packet must execute workspace redirect retirement")
    require('"retirement_allowed": true' in retirement_packet_text, "task/run route retirement packet must allow the executed retirement")
    require("executed_task_run_workspace_redirect_retirement" in retirement_packet_text, "task/run route retirement packet must record execution status")
