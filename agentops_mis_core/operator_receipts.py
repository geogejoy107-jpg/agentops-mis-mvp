...
def operator_action_receipt_public(row: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "prepared_action_id": metadata.get("prepared_action_id"),
        "prepared_action_hash": metadata.get("prepared_action_hash"),
        "prepared_action_current_hash": metadata.get("prepared_action_current_hash"),
        "prepared_action_hash_match": metadata.get("prepared_action_hash_match"),
        "prepared_action_status": metadata.get("prepared_action_status"),
        "required_prepared_action_status": metadata.get("required_prepared_action_status"),
        "prepared_action_approval_id": metadata.get("prepared_action_approval_id"),
        "prepared_action_run_id": metadata.get("prepared_action_run_id"),
        "prepared_action_type": metadata.get("prepared_action_type"),
        "prepared_action_approved_at": metadata.get("prepared_action_approved_at"),
        "prepared_action_consumed_at": metadata.get("prepared_action_consumed_at"),
        "prepared_action_provider_side_effect_id": metadata.get("prepared_action_provider_side_effect_id"),
        "prepared_action_result_summary": metadata.get("prepared_action_result_summary"),
        "prepared_action_consumed": metadata.get("prepared_action_consumed"),
        "prepared_action_approved": metadata.get("prepared_action_approved"),
