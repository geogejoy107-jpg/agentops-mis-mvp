...
try {
  ...
  for (const [name, bytes, pattern] of [
    ...
    ["mode-range", archive([{ name: "mode", body: Buffer.from("x"), metadata: { mode: 0o10000 } }]), /runtime_oci_export_tar_mode_range_rejected/],
    ["suid", archive([{ name: "suid", body: Buffer.from("x"), metadata: { mode: 0o4555 } }]), /runtime_oci_export_tar_setid_rejected/],
    ["sgid", archive([{ name: "sgid", body: Buffer.from("x"), metadata: { mode: 0o2555 } }]), /runtime_oci_export_tar_setid_rejected/],
    ["uid-range", archive([{ name: "uid", body: Buffer.from("x"), metadata: { uid: 65_536 } }]), /runtime_oci_export_tar_uid_range_rejected/],
    ["gid-range", archive([{ name: "gid", body: Buffer.from("x"), metadata: { gid: 65_536 } }]), /runtime_oci_export_tar_gid_range_rejected/],
